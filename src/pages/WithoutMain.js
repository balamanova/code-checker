...
import { checkCodeResult } from '../service/CodeParserApi';


function WithMain() {
  var zipFile, resultFile;
  ...
  acceptedFiles.map(file => {
    ...
    checkCodeResult(zipFile, resultFile).then(res => {
      setResponse(res)
    })
  }
       ...
       <div>
         <ul className = "note">
           ...
           <li>
             ...
             2. Expected Result .txt(or some another text format file) file
             </pre>
           </li>
         </ul>
        ...
        {({
          ...
          return (
            ...
            >
              ...
              <p>Drag'n'drop zip and expected output .txt file</p>
            </div>
          );
        }}
      </Dropzone>
